...
from src.business.emoji_service import EmojiService
...
from src.controller.mattermost_emoji_handler import MattermostEmojiHandler
...
from src.controller.slack_emoji_handler import SlackEmojiHandler
...
class Containers(containers.DeclarativeContainer):
    ...
    config_repo = providers.Singleton(ConfigRepository)
    config_service = providers.Singleton(ConfigService, config_repo=config_repo)
    ...
    slack_emoji_handler = providers.Factory(SlackEmojiHandler, slack_web_client)
    mattermost_emoji_handler = providers.Factory(MattermostEmojiHandler, mattermost_web_client)
    ...
    emoji_service = providers.Factory(EmojiService, slack_emoji_handler, mattermost_emoji_handler, user_service)
